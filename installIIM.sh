...
$IIM_MEDIA/userinstc -installationDirectory $IIM_HOME/eclipse -log $IIM_HOME/IIM_Install.log -acceptLicense | tee -a logs/install.log;

else

echo "Installing as Root" | tee -a logs/install.log;
echo $IIM_HOME
$IIM_MEDIA/installc -installationDirectory $IIM_HOME/eclipse -log $IIM_HOME/IIM_Install.log -acceptLicense | tee -a logs/install.log;
